...
:::: columns
::: {.column width="55%"}
![Original visualization by *Information is Beautiful*](imgs/original_visualization.png){.border-img fig-alt="Bubble chart showing dependency on Russian gas exports" width="100%"}
:::
::: {.column width="45%"}
