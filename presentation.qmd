...
:::: columns
::: {.column width="55%"}
![Original visualization by *Information is Beautiful*](original_visualisation.png){.border-img fig-alt="Bubble chart showing dependency on Russian gas exports" width="100%"}
:::
::: {.column width="45%"}
...
war_dep <- read_xlsx("data/UkraineRussia_War_Graphics_.xlsx",
                     sheet = "% dependency on Russian Gas - V")

war_support <- read_xlsx("data/UkraineRussia_War_Graphics_.xlsx",
